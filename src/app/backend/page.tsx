...
const Backend = () => {
  ...
  const contentProps: DirectionContentProps = {
    ...
    aboutList: ['от 60 тыс. до 90 тыс. сом для начинающих специалистов;', 'от 120 тыс. до 250 тыс. рублей для специалистов уровня middle (обычно от трех-пяти лет опыта);', 'до 400 тыс. сом и выше для позиции senior.'],
    aboutImg: aboutImg,
