...
const UXUI = () => {
  ...
  const contentProps: DirectionContentProps = {
    ...
    bannerBg: 'banner__content-uxui',
    bannerTitleColor: 'banner__title-uxui',
    bannerDescColor: 'banner__desc-uxui',
    advantagesIconBg: 'advantages__icon-uxui',
    advantagesDesc: 'advantages__desc-uxui',
